          ...
          <div className={styles.grid}>
            ...
            <RevealOnScroll>
              <div className={styles.channels}>
                ...
                <div className={styles.responseTime}>
                  ...
                  <p>Thời gian phản hồi: <strong>Trong vòng 2–4 giờ</strong> (trong giờ hoạt động)</p>
                </div>
              </div>
            </RevealOnScroll>
            ...
            <RevealOnScroll delay={150}>
              <div className={styles.faqMini}>
                <h2 className={styles.sectionTitle}>Trả lời nhanh</h2>
                <div className={styles.faqList}>
                  {[
                    { q: '🚀 Đặt hàng nhanh nhất qua đâu?', a: 'Inbox thẳng Facebook Messenger: m.me/thelaf.vn — shop phản hồi và tư vấn ngay!' },
                    { q: '📍 Shop giao hàng đến đâu?', a: 'Giao toàn quốc qua các đơn vị vận chuyển uy tín (GHN, GHTK, v.v.).' },
